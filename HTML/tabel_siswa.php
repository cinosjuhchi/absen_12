...
$jumlah = 5;
$jumlahdata = count(query("SELECT * FROM siswa_12"));
...
$pplg = query("SELECT * FROM siswa_12 WHERE kelas = '$kelas' AND jurusan = '$jurusan' LIMIT $awalData, $jumlah");

if( isset($_POST["cari"]) ){
    $pplg = cari($_POST["keyword"]);
}
if(isset($_POST["filter"])){
    $pplg = filter($_POST["keyword"]);
}
            ...
            <div class="row">
                ...
                <div class="col-9">
                    ...
                    <a href="" target="_self">Refresh</a>
                        ...
                        <form action="" method="post" class="d-flex col-1">
                        <select name="keyword" aria-label="Default select example">
                            ...
                            <button class="btn btn-outline-success" name="filter" type="submit">Filter</button>
                        </form>
                    ...
                    <div class="row col-12 align-items-center">
                        <table class="table table-success table-striped table-c">
                            <thead class="thd">
                                ...
                                <th class="col text-center">
                                    <h3 class="Roboto">Kelas</h3>
                                </th>
                                <th class="col text-center">
                                    <h3 class="Roboto">Jurusan</h3>
                                </th>
                            </thead>
                            <tbody>
                            ...
                            <?php foreach($pplg as $rpl) : ?>
                                <tr class="td-c">
                                    ...
                                    <td class="text-center">
                                        <p class="Roboto mark-20"><?= $rpl['kelas'];?></p>
                                    </td>                                                                                               
                                    <td class="text-center">
                                        <p class="Roboto mark-20"><?= $rpl['jurusan'];?></p>
                                    </td>                                                                                               
                                </tr>              
                                <?php endforeach;?>
                            </tbody>
