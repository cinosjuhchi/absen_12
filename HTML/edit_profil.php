    ...
    <div class="row">
        ...
        <div class="col-8 d-flex flex-column align-items-center all-acc">
            <div class="row text-center">
                <img src="../img/<?= $nm['gambar'];?>" class="img-thumbnai" alt="...">
            </div>
            <div class="col-10 info-akun">
                <div class="col-10 d-flex flex-column">
                    <form action="" method="post">
                    <h3 class="mark-28">Nama</h3>
                    <input class="block-c" type="text" value="<?= $nm['nama'];?>">
                    <h3 class="mark-28">Username</h3>
                    <input class="block-c" type="text" value="<?= $nm['user'];?>">
                    <h3 class="mark-28">Umur</h3>
                    <input class="block-c" type="text" value="<?= $nm['umur'];?>">
                    <h3 class="mark-28">File Gambar</h3>
                    <input class="block-s" type="file">
                    <button class="btn third">Edite</button>
                </form>
                </div>
            </div>
        </div>
